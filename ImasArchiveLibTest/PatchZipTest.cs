...
namespace ImasArchiveLibTest
{
    ...
    public class PatchZipTest
    {
        ...
        [DataRow("patch/patch_add.zip", 
            ...
            "patch/pastbl_tl.xlsx",
            "patch/translatedcommu.xlsx", 
            "patch/images")]
        public async Task AddToPatchTest(string filename, string newFileName, string jajpName, string parameterName, string pastblName, string commuName, string gtfDir)
        {
            using PatchZipFile patchZipFile = new PatchZipFile(filename, PatchZipMode.Create);
            ...
            patchZipFile.AddPastbl(pastblName);
